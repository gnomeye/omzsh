...
if [[ -x `which yaourt` ]]; then
  ...
  if [[ -x `which abs` ]]; then
    alias yaupd='yaourt -Sy && abs'   # Update and refresh the local package and ABS databases against repositories
  else
...
#else
#  alias pacupd='pacman -Sy'     # Update and refresh the local package and ABS databases against repositories
#fi
